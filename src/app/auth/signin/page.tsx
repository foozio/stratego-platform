      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-neutral-600">
            Strategic business planning & execution platform
          </p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          {error && (
            <div className="rounded-md bg-danger bg-opacity-10 p-4">
              <div className="flex">
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                className="input appearance-none rounded-none relative block w-full px-3 py-2 placeholder-neutral-500 rounded-t-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <input
                ...
                className="input appearance-none rounded-none relative block w-full px-3 py-2 placeholder-neutral-500 rounded-b-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm"
